                ...
                <div className='flex m-auto w-2/3 justify-between items-start 0 -mt-11'>
                    <div className='bg-white w-[70%] rounded p-3 shadow'>
                        ...
                        <nav className='flex text-reg border-b pb-2'>
                            <Link
                                href='/restaurant/milestone-grill'
                                className='mr-7'>
                                Overview
                            </Link>
                            <Link
                        ...
                        <div className='mt-4'>
                            <p className='text-lg font-light'>
                                The classics you love prepared with a perfect
                                twist, all served up in an atmosphere that feels
                                just right. That’s the Milestones promise. So,
                                whether you’re celebrating a milestone, making
                                the most of Happy Hour or enjoying brunch with
                                friends, you can be sure that every Milestones
                                experience is a simple and perfectly memorable
                                one.
                            </p>
                        </div>
                        {/* DESCRIPTION */} {/* IMAGES */}
                                ...
                                <div className='border-b pb-7 mb-7'>
                                    <div className='flex'>
                                        ...
                                        <div className='ml-10 w-5/6'>
                                            ...
                                            <div className='mt-5'>
                                                <p className='text-lg font-light'>
                                                    Laurie was on top of
                                                    everything! Slow night due
                                                    to the snow storm so it
                                                    worked in our favor to have
                                                    more one on one with the
                                                    staff. Delicious and well
                                                    worth the money.
                                                </p>
                                            </div>
                                        </div>
